...
import { FormMapName, FormMapDesc, FormButtons } from "./CreateEditComponents";
...
const CreateNewMap = () => {
    ...
    return (
        <div className='flex px-12 flex-col border text-sm text-gray-500 w-1/3 p-8 rounded-lg h-min shadow-[0_0_60px_0px_rgba(0,0,0,0.05)] animate-page-slide-up'>
